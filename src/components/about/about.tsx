...
// Constants
import { ABOUT_TEXT_3 } from 'constants/common';

// Jsons
import Profiles from 'jsons/profiles.json';

// Assets
import ProfileImg from 'assets/img/sternn.jpg';
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4">
            <img src={ProfileImg} className="image" alt="" />
          </div>
          <div className="col-lg-8 pt-4 pt-lg-0 content">
            <h3>JOSEPHEN STERN S. SALERA</h3>
